...
export declare const isSafeOperation: (response: unknown) => response is SafeOperation;
...
export declare const isSafeOperationResponse: (response: unknown) => response is SafeOperationResponse;
export {};
