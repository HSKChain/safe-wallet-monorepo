...
export interface paths {
  ...
  "/v1/targeted-messaging/outreaches/{outreachId}/chains/{chainId}/safes/{safeAddress}/signers/{signerAddress}/submissions": {
    ...
    get: operations["TargetedMessagingController_getSubmission"];
    put?: never;
    post: operations["TargetedMessagingController_createSubmission"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    Chain: {
      ...
      beaconChainExplorerUriTemplate: Record<string, never>;
      ...
      features: string[];
      gasPrice: (
        | components["schemas"]["GasPriceOracle"]
        | components["schemas"]["GasPriceFixed"]
        | components["schemas"]["GasPriceFixedEIP1559"]
      )[];
    ...
    LockingEventPage: {
      ...
      previous?: string | null;
      results: (
        | components["schemas"]["LockEventItem"]
        | components["schemas"]["UnlockEventItem"]
        | components["schemas"]["WithdrawEventItem"]
      )[];
    };
    Contract: {
      address: string;
    ...
    DataDecodedParameter: {
      ...
      valueDecoded?: (Record<string, never> | Record<string, never>[]) | null;
    };
    DataDecoded: {
      method: string;
    ...
    RichDecodedInfo: {
      fragments: (
        | components["schemas"]["RichTokenValueFragment"]
        | components["schemas"]["RichTextFragment"]
        | components["schemas"]["RichAddressFragment"]
      )[];
    };
    TransactionInfo: {
      type: string;
    ...
    TransactionDetails: {
      ...
      detailedExecutionInfo?:
        | (
            | components["schemas"]["MultisigExecutionDetails"]
            | components["schemas"]["ModuleExecutionDetails"]
          )
        | null;
      txHash?: string | null;
    ...
    SettingsChangeTransaction: {
      ...
      settingsInfo?: components["schemas"]["SettingsChange"] | null;
    };
    Transfer: {
      type: string;
    };
    ...
    Transaction: {
      ...
      txInfo: components["schemas"]["TransactionInfo"] &
        (
          | components["schemas"]["CreationTransactionInfo"]
          | components["schemas"]["CustomTransactionInfo"]
          | components["schemas"]["SettingsChangeTransaction"]
          | components["schemas"]["SwapOrderTransactionInfo"]
          | components["schemas"]["SwapTransferTransactionInfo"]
          | components["schemas"]["TwapOrderTransactionInfo"]
          | components["schemas"]["TransferTransactionInfo"]
          | components["schemas"]["NativeStakingDepositTransactionInfo"]
          | components["schemas"]["NativeStakingValidatorsExitTransactionInfo"]
          | components["schemas"]["NativeStakingWithdrawTransactionInfo"]
        );
      executionInfo?:
        | (
            | components["schemas"]["MultisigExecutionInfo"]
            | components["schemas"]["ModuleExecutionInfo"]
          )
        | null;
      safeAppInfo?: components["schemas"]["SafeAppInfo"] | null;
    };
    ...
    QueuedItemPage: {
      ...
      previous?: string | null;
      results: (
        | components["schemas"]["ConflictHeaderQueuedItem"]
        | components["schemas"]["LabelQueuedItem"]
        | components["schemas"]["TransactionQueuedItem"]
      )[];
    };
    TransactionItem: {
      type: string;
...
export interface operations {
  ...
  TargetedMessagingController_getSubmission: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  TargetedMessagingController_createSubmission: {
    parameters: {
      query?: never;
      header?: never;
      path: {
      ...
      200: {
        ...
        content: {
          "application/json":
            ...
            | components["schemas"]["CowSwapConfirmationView"]
            | components["schemas"]["CowSwapTwapConfirmationView"]
            | components["schemas"]["NativeStakingDepositConfirmationView"]
            | components["schemas"]["NativeStakingValidatorsExitConfirmationView"]
            | components["schemas"]["NativeStakingWithdrawConfirmationView"];
        };
      };
    };
  };
